...
export default function ProductForm({ mode, productId }: Props) {
    ...
    const [formData, setFormData] = useState({
        ...
        description: "", slug: "", sku: "", discountPrice: "",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            fd.append(isEdit ? "productSizes" : "sizes", JSON.stringify(sizes));
            ...
            <form onSubmit={handleSubmit}>
                <div className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-3xl shadow-2xl overflow-hidden">
                        ...
                        <div className="space-y-5 mt-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div
                                    ...
                                    className={`flex items-center justify-between p-4 rounded-2xl border cursor-pointer transition-all col-span-2 ${formData.featured ? "border-teal-500 bg-teal-500/5" : "border-slate-200 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-800/40"}`}
                                >
                                    <div className="flex items-center gap-3">
                    ...
                    <div className="p-8 border-b border-slate-200 dark:border-zinc-800">
                        ...
                        {colors.length === 0 ? (
                            <p className="text-slate-400 dark:text-zinc-600 text-sm text-center py-6 border-2 border-dashed border-slate-200 dark:border-zinc-800 rounded-2xl">Өнгө нэмэгдээгүй байна</p>
                        ) : (
                    ...
                    <div className="p-8 border-b border-slate-200 dark:border-zinc-800">
                        ...
                        {sizes.length === 0 ? (
                            <p className="text-slate-400 dark:text-zinc-600 text-sm text-center py-6 border-2 border-dashed border-slate-200 dark:border-zinc-800 rounded-2xl">Хэмжээ нэмэгдээгүй байна</p>
                        ) : (
                            <div className="space-y-3">
                                {sizes.map((s, i) => (
                                    <div key={i} className="flex items-center gap-3 bg-slate-50 dark:bg-zinc-800/40 p-3 rounded-2xl">
