  ...
  return (
    <section className="relative py-16 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center text-white z-10">
        <h3 className="text-4xl md:text-5xl font-extrabold mb-5">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button onClick={openRegister} className="w-full sm:w-auto bg-white text-teal-600 px-8 py-4 rounded-full font-bold hover:bg-slate-50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            Одоо бүртгүүлэх
          </button>
          <Link href="/product">
