...
// import { Product, ProductWithRelations } from "@/interface/product";
...
//           {/* Sidebar Filters (Desktop) / Header Filters (Mobile) */}
...
//                   Ангилал
//                 </h3>
//                 {/* Энд CategoryRow-г sidebar маягаар эсвэл жагсаалт маягаар ашиглаж болно */}
...
//                 {categories.find((e) => e.id == selectedCatId)?.name} <span className="text-slate-400 font-normal">({products.length})</span>
//               </h2>
//               <div className="flex gap-2">
//                 <select className="bg-transparent border-none text-sm font-semibold text-slate-600 dark:text-slate-400 focus:ring-0 cursor-pointer">
...
//           <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Хүссэн бараагаа олсонгүй юу?</h3>
//           <p className="text-slate-500 mb-8">Манайд өдөр бүр шинэ бараанууд нэмэгддэг тул та дахин зочлоорой.</p>
//           <div className="flex justify-center gap-4">
//             <div className="w-10 h-10 rounded-full bg-teal-100 dark:bg-teal-900/30 text-teal-600 flex items-center justify-center cursor-pointer hover:scale-110 transition">f</div>
//             <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 flex items-center justify-center cursor-pointer hover:scale-110 transition">in</div>
//             <div className="w-10 h-10 rounded-full bg-pink-100 dark:bg-pink-900/30 text-pink-600 flex items-center justify-center cursor-pointer hover:scale-110 transition">ig</div>
//           </div>
//         </div>
//       </section>
