...
export default function ProductDetail() {
    ...
    // const [imageUrl, setImageUrl] = useState('/uploads/placeholder.png');
    ...
    if(!product) {
        return <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col lg:flex-row pt-16">
            CANT FETCH PRODUCT
        </div>
    }
